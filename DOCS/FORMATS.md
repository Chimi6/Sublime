...
| image | bmp | Windows bitmap | bmp, dib | png-to-bmp, jpeg-to-bmp | bmp-to-png, bmp-to-jpeg |
| image | jpeg | JPEG image | jpg, jpeg, jpe | png-to-jpeg, bmp-to-jpeg | jpeg-to-png, jpeg-to-bmp |
| image | png | PNG image | png | bmp-to-png, jpeg-to-png | png-to-bmp, png-to-jpeg |
...
| png-to-bmp | png | bmp | native | conditional | 16-bit samples become 8-bit, gray becomes RGB, and metadata (gamma, color profile, text) is dropped |
| bmp-to-png | bmp | png | native | lossless |  |
| jpeg-to-png | jpeg | png | native | conditional | pixels as decoded (Exif orientation is reported, not applied); metadata (Exif, ICC, comments) is dropped |
| jpeg-to-bmp | jpeg | bmp | native | conditional | pixels as decoded (Exif orientation is reported, not applied); metadata (Exif, ICC, comments) is dropped |
| png-to-jpeg | png | jpeg | native | lossy | JPEG is lossy: the image is re-encoded at the quality given (85 by default, 4:2:0 chroma below 90), alpha is flattened onto white, and metadata is dropped |
| bmp-to-jpeg | bmp | jpeg | native | lossy | JPEG is lossy: the image is re-encoded at the quality given (85 by default, 4:2:0 chroma below 90), alpha is flattened onto white, and metadata is dropped |

## Paths

| From | To | Fidelity | Path | Notes |
|---|---|---|---|---|
| bmp | jpeg | lossy | bmp-to-jpeg | JPEG is lossy: the image is re-encoded at the quality given (85 by default, 4:2:0 chroma below 90), alpha is flattened onto white, and metadata is dropped |
| bmp | png | lossless | bmp-to-png |  |
...
| jpeg | bmp | conditional | jpeg-to-bmp | pixels as decoded (Exif orientation is reported, not applied); metadata (Exif, ICC, comments) is dropped |
| jpeg | png | conditional | jpeg-to-png | pixels as decoded (Exif orientation is reported, not applied); metadata (Exif, ICC, comments) is dropped |
...
| png | bmp | conditional | png-to-bmp | 16-bit samples become 8-bit, gray becomes RGB, and metadata (gamma, color profile, text) is dropped |
| png | jpeg | lossy | png-to-jpeg | JPEG is lossy: the image is re-encoded at the quality given (85 by default, 4:2:0 chroma below 90), alpha is flattened onto white, and metadata is dropped |
...
graph LR
  ...
  png -- conditional --> bmp
  bmp --> png
  jpeg -- conditional --> png
  jpeg -- conditional --> bmp
  png -. lossy .-> jpeg
  bmp -. lossy .-> jpeg
```
