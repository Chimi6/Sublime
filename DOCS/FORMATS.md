...
|---|---|---|---|---|---|
| data | csv | Comma-Separated Values | csv | json-to-csv, jsonl-to-csv, tsv-to-csv, xlsx-to-csv | csv-to-json, csv-to-jsonl, csv-to-tsv, csv-to-xlsx |
...
| data | tsv | Tab-Separated Values | tsv, tab | json-to-tsv, jsonl-to-tsv, csv-to-tsv, xlsx-to-tsv | tsv-to-json, tsv-to-jsonl, tsv-to-csv, tsv-to-xlsx |
...
| document | docx | Word document | docx | pages-to-docx, markdown-to-docx, html-to-docx, text-to-docx | docx-to-markdown, docx-to-html, docx-to-text, docx-to-pages |
| document | html | HTML | html, htm | markdown-to-html, pages-to-html, docx-to-html, text-to-html | html-to-pages, html-to-markdown, html-to-text, html-to-docx |
| document | markdown | Markdown | md, markdown | markdown-json-to-markdown, pages-to-markdown, docx-to-markdown, html-to-markdown, text-to-markdown | markdown-to-html, markdown-to-text, markdown-to-json, markdown-to-docx, markdown-to-pages |
| document | markdown-json | Markdown events as JSON |  | markdown-to-json | markdown-json-to-markdown |
| document | pages | Apple Pages | pages | json-to-pages, markdown-to-pages, text-to-pages, html-to-pages, docx-to-pages | pages-to-json, pages-to-docx, pages-to-markdown, pages-to-html, pages-to-text |
| document | pages-json | Apple Pages package as JSON |  | pages-to-json | json-to-pages |
| document | text | Plain text | txt | markdown-to-text, pages-to-text, docx-to-text, html-to-text | text-to-pages, text-to-markdown, text-to-html, text-to-docx |
...
| markdown-to-pages | markdown | pages | native | lossy | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
| text-to-pages | text | pages | native | lossy | paragraphs reach Pages as body text; text carries no other structure |
| html-to-pages | html | pages | native | lossy | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
| docx-to-pages | docx | pages | native | lossy | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, links become clickable hyperlinks, and inline images are placed with their bytes and size |
...
| docx | pages | lossy | docx-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, links become clickable hyperlinks, and inline images are placed with their bytes and size |
| docx | pages-json | lossy | docx-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, links become clickable hyperlinks, and inline images are placed with their bytes and size |
...
| html | pages | lossy | html-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
| html | pages-json | lossy | html-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
...
| markdown | pages | lossy | markdown-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
| markdown | pages-json | lossy | markdown-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
...
| markdown-json | pages | lossy | markdown-json-to-markdown -> markdown-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
| markdown-json | pages-json | lossy | markdown-json-to-markdown -> markdown-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, bold and italic runs reuse its character styles, and links become clickable hyperlinks; images are not yet written |
...
| text | pages | lossy | text-to-pages | paragraphs reach Pages as body text; text carries no other structure |
| text | pages-json | lossy | text-to-pages -> pages-to-json | paragraphs reach Pages as body text; text carries no other structure |
