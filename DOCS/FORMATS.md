...
| markdown-to-pages | markdown | pages | native | lossy | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
| text-to-pages | text | pages | native | lossy | paragraphs reach Pages as body text; text carries no other structure |
| html-to-pages | html | pages | native | lossy | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
| docx-to-pages | docx | pages | native | lossy | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
...
| docx | pages | lossy | docx-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
| docx | pages-json | lossy | docx-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
...
| html | pages | lossy | html-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
| html | pages-json | lossy | html-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
...
| markdown | pages | lossy | markdown-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
| markdown | pages-json | lossy | markdown-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
...
| markdown-json | pages | lossy | markdown-json-to-markdown -> markdown-to-pages | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
| markdown-json | pages-json | lossy | markdown-json-to-markdown -> markdown-to-pages -> pages-to-json | paragraphs, headings, bulleted and numbered lists, and tables reach Pages with its named styles, and bold and italic runs reuse its character styles; links and images are not yet written |
