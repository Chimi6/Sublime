...
| document | docx | Word document | docx | pages-to-docx, markdown-to-docx | docx-to-markdown, docx-to-html, docx-to-text |
| document | html | HTML | html, htm | markdown-to-html, pages-to-html, docx-to-html | - |
| document | markdown | Markdown | md, markdown | markdown-json-to-markdown, pages-to-markdown, docx-to-markdown | markdown-to-html, markdown-to-text, markdown-to-json, markdown-to-docx |
