...
| document | docx | Word document | docx | pages-to-docx | - |
| document | html | HTML | html, htm | markdown-to-html, pages-to-html | - |
| document | markdown | Markdown | md, markdown | markdown-json-to-markdown, pages-to-markdown | markdown-to-html, markdown-to-text, markdown-to-json |
...
| document | text | Plain text | txt | markdown-to-text, pages-to-text | - |
