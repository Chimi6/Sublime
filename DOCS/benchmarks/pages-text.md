...
**Latest** (2026-09-24, typed decode: pages -> text 31.8 MB/s of input on the dense shape and 31.1 on prose, at 48.2 and 34.9 MB peak; memory PASSES on both shapes, throughput FAILS on both, see Conclusions and `STATE.md`)
