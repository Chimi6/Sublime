...
**Latest** (2026-09-24: pages -> html 15.2 MB/s of input on the dense shape and 18.7 on prose, at 142.3 and 64.3 MB peak; both goals (50 MB/s, 64 MB) FAIL, see Conclusions and `STATE.md`)
